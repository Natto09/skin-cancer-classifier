...
#
# Currently set to the 1M dataset. To train on the 6M dataset instead, either
# change the line below, or pass --meta_csv "all_augment_6M/meta.csv" on the
# command line (the CLI flag always overrides this default).
# =============================================================================
DEFAULT_META_CSV = "all_augment_6M/meta.csv"
...
def save_checkpoint(path, model, optimizer, scheduler, epoch, step, best_val_loss, counter,
