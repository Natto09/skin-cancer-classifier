...
def main():
    ...
    parser.add_argument("--best_model_path", default="skin_cancer_best_vit_1M.pth")
    parser.add_argument("--checkpoint_path", default="train_checkpoint_vit_1M.pth")
    ...
    # --- 3. Model (ViT-B/16, last 2 transformer blocks unfrozen -- ensemble member 3/3) ---
