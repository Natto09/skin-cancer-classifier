...
FLIPS = {
    ...
    "Fy": Image.FLIP_TOP_BOTTOM,
}
 
ROTATIONS = [0, 90, 270, 45, 135, 215, 305, 180]
TONE_LEVELS = [-2, -1, 0, 1, 2]
...
def main():
    ...
    parser.add_argument("--output_dir", default="all augment", help='Output root folder (default: "all augment")')
